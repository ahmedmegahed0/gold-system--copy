        ...
        <html lang="ar" dir="rtl">
          <head>
            ...
            <style>
              ...
              .left-box { left: 0; bottom: 0; }
              .right-box { right: 0; top: 0; }
              .top-half { width: 100%; height: 12.5mm; display: flex; flex-direction: column; justify-content: center; align-items: center; transform: rotate(180deg); overflow: hidden; padding-bottom: 3.5mm; box-sizing: border-box; }
              .bottom-half { width: 100%; height: 12.5mm; display: flex; flex-direction: column; justify-content: center; align-items: center; overflow: hidden; padding-top: 3.5mm; box-sizing: border-box; font-size: 5.5pt; font-weight: bold; line-height: 1.2; }
              .barcode-img { max-height: 7mm; width: 18mm; margin-bottom: 2mm; }
